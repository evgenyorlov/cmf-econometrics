...
# Applied Econometrics 1, R Basics Орлов Евгений, 20.11.2014
...
plot(rosn.dates, rosn.close, type = "l", xlab = "index", ylab = "close", main = "Rosneft:Close")
# Графики доходностей
...
plot(rosn.dates[-1], rosn.ret, type = "l", xlab = "index", ylab = "return", main = "Rosneft:Return")
