...
# Applied econometrics 4, VaR curve using GARCH
...
# ОПТИМАЛЬНЫЙ ПОРЯДОК МОДЕЛИ ARMA(m, n) НА ОСНОВЕ КРИТЕРИЯ АКАИКЕ ####
arma.coef.aic <- function(ret, a, b) {
  # Выбор оптимальных коэффициентов ARMA(a, b) для ret
